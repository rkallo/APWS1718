...
x1, y1 = np.loadtxt('1.txt', unpack=True, delimiter=',')
x2, y2 = np.loadtxt('2.txt', unpack=True, delimiter=',')
x3, y3 = np.loadtxt('3.txt', unpack=True, delimiter=',')
x4, y4 = np.loadtxt('4.txt', unpack=True, delimiter=',')
x5, y5 = np.loadtxt('5.txt', unpack=True, delimiter=',')
x6, y6 = np.loadtxt('6.txt', unpack=True, delimiter=',')
x7, y7 = np.loadtxt('7.txt', unpack=True, delimiter=',')
x8, y8 = np.loadtxt('8.txt', unpack=True, delimiter=',')
x9, y9 = np.loadtxt('9.txt', unpack=True, delimiter=',')
x10, y10 = np.loadtxt('10.txt', unpack=True, delimiter=',')
